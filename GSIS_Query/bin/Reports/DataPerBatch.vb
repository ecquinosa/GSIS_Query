...
Public Class DataPerBatch
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GSIS_Query.DataPerBatch.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_batchFrom() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_batchTo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedDataPerBatch
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DataPerBatch = New DataPerBatch
        rpt.Site = Me.Site
        Return rpt
    End Function
